...
public class HotFixLinkedFSM_CreatePackageDownloader : FSMLinkedStaterItemBase
{
    private CoroutineHandler coroutine = null;

    public override void OnEnter()
    {
        HotFixEventMessage.PatchStatesChange.SendEventMessage("创建补丁下载器！");
    ...
    private IEnumerator CreateDownloader()
    {
        ...
        else
        {
            ...
            HotFixEventMessage.FoundUpdateFiles.SendEventMessage(totalDownloadCount, totalDownloadBytes);
        }
    }
}
